	...
	public class P3dHitCache
	{
		...
		private void Cache(GameObject gameObject)
		{
			...
			for (var i = 0; i < hits.Count; i++)
			{
				...
				var hitTriangle = hit as IHitTriangle; if (hitTriangles != null) { hitTriangles.Add(hitTriangle); }

				var hitQuad = hit as IHitQuad; if (hitQuads != null) { hitQuads.Add(hitQuad); }

				var hitCoord = hit as IHitCoord; if (hitCoords != null) { hitCoords.Add(hitCoord); }
			}
		}
	}
}